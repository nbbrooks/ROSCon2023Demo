...
//    { -1.f, 0.5, 2.f }, { 0.f, 0.5f, 2.f }, { 1.f, 0.5f, 2.f }, { -1.f, -0.5f, 2.f }, { 0.f, -0.5f, 2.f }, { 1.f, -0.5f, 2.f },
        { -1.0f, 0.5f, 1.f },  { 0.0f, 0.5f, 1.f }, { 1.0f, 0.5f, 1.f }, { -1.0f, -0.5f, 1.f }, { 0.0f, -0.5f, 1.f }, { 1.0f, -0.5f, 1.f },
        { -1.0f, 0.5f, 2.f },  { 0.0f, 0.5f, 2.f }, { 1.0f, 0.5f, 2.f }, { -1.0f, -0.5f, 2.f }, { 0.0f, -0.5f, 2.f }, { 1.0f, -0.5f, 2.f },
        { -1.0f, 0.5f, 3.f },  { 0.0f, 0.5f, 3.f }, { 1.0f, 0.5f, 3.f }, { -1.0f, -0.5f, 3.f }, { 0.0f, -0.5f, 3.f }, { 1.0f, -0.5f, 3.f },
